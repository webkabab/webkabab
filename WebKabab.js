...
switch (proc) {
    case "request_live_playlist":	// This procedure requests a playlist (or several playlists) from this server.        
        //postMessage({type: 'requestLivePlaylist', content: {"Web Kabab Playlist", "https://www.dropbox.com/s/y9yyi16nuwploav/myRussianList.m3u?dl=1"}});
		TiviProvider.sendPlaylist(req, "Web Kabab Channels", "https://www.dropbox.com/s/9ra1194cekuprob/webkabab.m3u?dl=1");        
